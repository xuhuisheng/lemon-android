...
public class TaskAsyncTask extends AsyncTask<ListView, Void, Void> {
    ...
    public TaskAsyncTask(String urlText, Activity activity, String sessionId) {
    ...
    public void updateData() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("message_title", (String) jsonObject.get("presentationSubject"));
                map.put("message_time", "");
                map.put("message_body", (String) jsonObject.get("assigneeDisplayName") + " " + (String) jsonObject.get("createTime"));
                map.put("taskId", jsonObject.get("id").toString());
                list.add(map);
            }
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(activity, list,
                    R.layout.item_task,
                    new String[] { "message_title", "message_time", "message_body" }, new int[] {
                            R.id.message_title, R.id.message_time, R.id.message_body });
            // 添加并且显示
