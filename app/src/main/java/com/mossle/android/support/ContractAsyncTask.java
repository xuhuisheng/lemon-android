...
public class ContractAsyncTask extends AsyncTask<ListView, Void, Void> {
    ...
    public ContractAsyncTask(String urlText, Activity activity, String sessionId) {
    ...
    public void updateData() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("username", (String) jsonObject.get("name"));
                map.put("content", ((String) jsonObject.get("tel")) + " "
