...
public class ProcessDefinitionAsyncTask extends AsyncTask<ListView, Void, Void> {
    ...
    public ProcessDefinitionAsyncTask(String urlText, Activity activity,
            String sessionId) {
    ...
    public void updateData() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("ItemTitle", (String) jsonObject.get("name"));
                map.put("ItemText", jsonObject.get("processDefinitionId").toString());
                map.put("processDefinitionId",
                        jsonObject.get("processDefinitionId").toString());
                list.add(map);
            }

            // 生成适配器，数组===》ListItem
            SimpleAdapter simpleAdapter = new SimpleAdapter(activity, list,
                    R.layout.item_process_definition,
