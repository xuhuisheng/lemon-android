...
public class ProcessInstanceAsyncTask extends AsyncTask<ListView, Void, Void> {
    ...
    public ProcessInstanceAsyncTask(String urlText, Activity activity,
            String sessionId) {
    ...
    public void updateData() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("ItemText", "");
                map.put("processInstanceId", jsonObject
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(activity, list,
                    R.layout.item_process_instance,
